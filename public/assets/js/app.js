    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/us.svg")
        : "sp" == e
        ? (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/spain.svg")
        : "gr" == e
        ? (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/germany.svg")
        : "it" == e
        ? (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/italy.svg")
        : "ru" == e
        ? (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/russia.svg")
        : "ch" == e
        ? (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/china.svg")
        : "fr" == e &&
          (document.getElementById("header-lang-img").src =
            "velzon/html/material/assets/images/flags/french.svg"),
  ...
  function E() {
    ...
    !a ||
      ...
      ((n = document.createElement("ul")).innerHTML =
        '<a href="#" class="logo"><img src="velzon/html/material/assets/images/logo-sm.png" alt="" height="22"></a>'),
      Array.from(
