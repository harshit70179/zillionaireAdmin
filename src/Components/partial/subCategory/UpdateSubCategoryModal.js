...
import { useUpdateSubCategoryMutation } from '../../../redux/subCategoryApi';

function UpdateSubCategoryModal(props) {
  ...
  useEffect(()=>{
    if(props.currentRecord){
      ...
      setMainCategoryId(props.currentRecord.main_category_id)
      setCategoryId(props.currentRecord.category_id)
    }
  },[props])
  ...
  const onsubmit = (e) => {
    ...
    updateSubCategory(data).then((result) => {
